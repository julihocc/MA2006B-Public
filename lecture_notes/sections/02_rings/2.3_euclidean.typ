...
#proof[
  ...
  Since $I eq.not {0}$, the set of norms ${N(x) : x in I, x eq.not 0}$ is a non-empty set of non-negative integers. By the Well-Ordering Principle, this set has a minimum element. Let $d in I$ be an element with this minimum norm $N(d)$.
  
  We claim that $I = chevron.l d chevron.r$. Since $d in I$ and $I$ is an ideal, it is clear that $chevron.l d chevron.r subset.eq I$.
