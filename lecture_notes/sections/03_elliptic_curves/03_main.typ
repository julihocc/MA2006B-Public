...
- Scalar multiplication gives elliptic-curve Diffie-Hellman as a concrete example of how algebraic structure can support cryptographic constructions.
...
#include "3.4_diffie_hellman_over_fp.typ"
